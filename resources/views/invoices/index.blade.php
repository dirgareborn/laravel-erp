...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <a href="{{ route('invoice.create')}}" class="btn btn-rounded btn-xs btn-info" >{{ __('adminlte::adminlte.add_new') }}</a>
            </div>
            </div>
            <div class="card-body">
                ...
                <x-adminlte-datatable id="table7" head-theme="bg-blue" :heads="$heads" striped hoverable bordered with-buttons compressed>
                    @foreach($invoices as $key => $row)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('invoice.edit', $row['id'])}}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
