...
<div class="row mb-2">
  <div class="col-sm-6">
    <h1>{{ __('adminlte::adminlte.invoices') }}</h1>
  </div>
  <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
      <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
      <li class="breadcrumb-item active">{{ __('adminlte::adminlte.invoices') }}</li>
    </ol>
  </div>
</div>
@stop
                    ...
                    <div class="row">
                                ...
                                <div class="info-box bg-default">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <x-adminlte-select id="customer_id" label="Customer" name="customer_id" :selected="old('customer_id')" required>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                @endphp
                                <x-adminlte-input-date name="date" :config="$config" label="Invoice Date" placeholder="Choose a date..." required fgroup-class="col-md-6 col-6">
                                ...
                                <x-adminlte-input id="number" name="number" label="Invoice Number" :value="old('number')" required fgroup-class="col-md-6 col-6" />
