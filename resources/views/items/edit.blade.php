        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('item.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                    <div class="row">
                    <x-adminlte-input name="name" id="name" label="item Name" value="{{ $item->name }}" fgroup-class="col-md-6 col-6"/>
                    <x-adminlte-input type="number" name="tax" id="tax" label="Tax" value="{{ $item->tax }}" fgroup-class="col-md-6 col-6"/>
                    @php
                    $config = [
                        "height" => "100",
                        "toolbar" => [
                    ...
                    <x-adminlte-input type="number" name="sale_price" id="sale_price" label="Sale Price" value="{{ $item->sale_price }}" fgroup-class="col-md-6 col-6"/>
                    <x-adminlte-input type="number" name="purchase_price" id="purchase_price" label="Purchase Price" value="{{ $item->purchase_price }}" fgroup-class="col-md-6 col-6"/>
